...
if __name__ == '__main__':
    ...
    print(current_tcp)
    # move_tcp = np.hstack((current_tcp[:3], [0.0, 0.0, 0.0]))
    # move_to_tcp(move_tcp)
    # move_tcp = np.hstack((current_tcp[:3], [3.14159265, 0.0, 0.0]))
    # move_to_tcp(move_tcp)

    # move_to_tcp([
    #     0.026874,   -0.71918004,  0.27186001, -1.76370631, -1.81144155, -0.80789608
    # ])
