...
def MaskRCNN():
    ...
    ROOT_DIR = os.path.abspath("/home/jiang/GProject/Mask/mask_labelme")
    ...
    COCO_MODEL_PATH = '/home/jiang/GProject/Mask/mask_labelme/mask_rcnn_shapes_0152.h5'
...
def detect_objects_in_image(image, model):
    ...
    global __k
    save_image = image[..., ::-1]
    cv2.imwrite('/home/jiang/GProject/Mask/mask_labelme/result/res' + str(__k) + '.jpg', save_image)
    __k += 1
    RESULT_SAVE_PATH = "/home/jiang/GProject/Mask/mask_labelme/result"
